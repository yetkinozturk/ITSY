...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'issue_history', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issue.Issue'], null=True, blank=True)),
        ...
        db.send_create_signal('issue', ['History'])


    def backwards(self, orm):
        # Deleting model 'History'
        db.delete_table(u'issue_history')
