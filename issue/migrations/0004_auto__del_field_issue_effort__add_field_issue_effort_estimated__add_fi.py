...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Issue.effort'
        db.delete_column(u'issue_issue', 'effort')

        # Adding field 'Issue.effort_estimated'
        db.add_column(u'issue_issue', 'effort_estimated',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.effort_remaining'
        db.add_column(u'issue_issue', 'effort_remaining',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Issue.effort'
        db.add_column(u'issue_issue', 'effort',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Issue.effort_estimated'
        db.delete_column(u'issue_issue', 'effort_estimated')

        # Deleting field 'Issue.effort_remaining'
        db.delete_column(u'issue_issue', 'effort_remaining')
    ...
    models = {
        ...
        'issue.issue': {
            ...
            'effort_estimated': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'effort_remaining': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
